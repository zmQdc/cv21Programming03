...
class Dataset_Seg():
    def __init__(self, imgs_dir, anno_dir=None, split='test'):
        ...
        with open(r'D:\study\大三下\cv\21\作业\cv21b.programming03\{}.txt'.format(split), 'r') as f:
    ...
    def get_loader(self):
        ...
        return zip(preds, gts, self.id_list)
...
if __name__ == '__main__':
    ...
    loader = Dataset_Seg(r'datasets/train',
                         r'D:\study\大三下\cv\21\作业\cv21b.programming03\dataset\annotations_trainval',
                         split='train').get_loader()
    evaluate(loader, 21)
